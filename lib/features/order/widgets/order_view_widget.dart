      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        ...
        return orderList != null
            ? orderList.isNotEmpty
                                          ...
                                          Row(children: [
                                            Container(
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: CustomImageWidget(
                                                  image: '${orderList![index].restaurant != null ? orderList[index].restaurant!.logo : ''}',
                                                  height: 80,
                                                  width: 80,
                                                  fit: BoxFit.cover,
                                                  isRestaurant: true,
                                            ...
                                            Expanded(
                                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                Text('#${orderList[index].id}', style: robotoBold),
                ...
                : SingleChildScrollView(child: FooterViewWidget(child: NoDataScreen(title: 'no_order_yet'.tr, isEmptyOrder: true)))

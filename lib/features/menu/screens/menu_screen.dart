...
class _MenuScreenState extends State<MenuScreen> {
              ...
              child: Row(children: [
                Container(
                  ...
                  child: ClipOval(
                    ...
                    image: '${(profileController.userInfoModel != null && isLoggedIn) ? profileController.userInfoModel!.image : ''}',
                    height: 70,
                    width: 70,
                    fit: BoxFit.cover,
  ...
  _manageCountryFunctionality() {
    // Get.find<CountryController>().saveCacheCountry(null);
    // Get.find<CountryController>().searchSelectedCountry();
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return ConstrainedBox(
          constraints: BoxConstraints(maxHeight: MediaQuery.of(context).size.height * 0.8),
          child: const CountryBottomSheetWidget(),
        );
      },
    ).then((value) => Get.find<CountryController>().setCountry());
  }
}

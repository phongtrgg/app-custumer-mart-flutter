...
class CheckoutController extends GetxController implements GetxService {
  ...
  Future<String> placeOrder(
    ...
    String orderID = '';
    XFile? bodyFile =
        _pickedPrescriptions.isNotEmpty ? _pickedPrescriptions[0] : null;

    Response response;
    if (bodyFile != null) {
      response =
          await checkoutServiceInterface.placeOrder(placeOrderBody, bodyFile);
    } else {
      response =
          await checkoutServiceInterface.placeOrder(placeOrderBody, null);
    }
...
// logic upload ảnh địa chỉ nơi nhận hàng
  ...
  //end logic upload ảnh địa chỉ nơi nhận hàng
}

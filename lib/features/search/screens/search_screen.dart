          ...
          return Column(children: [
                      ...
                      child: Row(children: [
                        ...
                        Expanded(
                          child: SearchAnchor(
                            ...
                            headerHintStyle: robotoRegular.copyWith(
                                fontSize: Dimensions.fontSizeDefault,
                                color: Theme.of(context).disabledColor),
                            textInputAction: TextInputAction.done,
                            viewLeading: IconButton(
                                onPressed: () => anchorController
                                    .closeView(anchorController.text),
            ...
            Expanded(
                child: searchController.isSearchMode
                    ...
                    : SearchResultWidget(
                        searchText: anchorController.text.trim())),
          ]);
        })),
        bottomNavigationBar:

    ...
    return PopScope(
      ...
      onPopInvoked: (val) async {
        if (!Get.find<search.SearchController>().isSearchMode) {
          ...
          widget.category == false ? Future.delayed(const Duration(milliseconds: 100), () => Get.back()) : Get.toNamed(RouteHelper.getCategoryRoute('category'));
        }
      },
      child: Scaffold(
                              ...
                              IconButton(
                                onPressed: () {
                                  if (anchorController.text.isNotEmpty) {
                                    ...
                                    widget.category == false ? anchorController.closeView('') : Get.toNamed(RouteHelper.getCategoryRoute('category'));
                                  }
                                },
                              ...
                              return Container(
                                ...
                                child: Row(children: [
                                  ...
                                  IconButton(
                                    ...
                                    icon: Icon(
                                      !searchController.isSearchMode ? Icons.filter_list : Icons.search,
                                      size: 28,
                                    ),
                                  )
                                ]),
                        ...
                        child: FooterViewWidget(
                          child: SizedBox(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                (_isLoggedIn && searchController.suggestedFoodList != null)
                                    ? Padding(
                                    ...
                                    : const SizedBox(),
                                (_isLoggedIn && searchController.suggestedFoodList != null)
                                    ? searchController.suggestedFoodList!.isNotEmpty
                                        ? Wrap(
                                                                  ...
                                                                  return InkWell(
                                                                    onTap: () {
                                                                      Get.toNamed(RouteHelper.getCuisineRestaurantRoute(
                                                                          cuisineController.cuisineModel!.cuisines![index].id, cuisineController.cuisineModel!.cuisines![index].name));
                                                                    },
                                                                    child: SizedBox(
                                                                      height: 130,

...
import '../features/country/domain/repositories/country_repository_interface.dart';
import '../features/country/domain/services/country_service.dart';
import '../features/country/domain/services/country_service_interface.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  CountryRepositoryInterface countryRepositoryInterface =
      CountryRepository(apiClient: Get.find(), sharedPreferences: Get.find());
  Get.lazyPut(() => countryRepositoryInterface);
  CountryServiceInterface countryServiceInterface =
      CountryService(countryRepositoryInterface: Get.find());
  Get.lazyPut(() => countryServiceInterface);
  //
  ...
  Get.lazyPut(() => CountryController(countryServiceInterface: Get.find()));

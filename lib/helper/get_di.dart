...
Future<Map<String, Map<String, String>>> init() async {
  ...
  //
  CountryRepositoryInterface countryRepositoryInterface = CountryRepository(apiClient: Get.find(), sharedPreferences: Get.find());
  Get.lazyPut(() => countryRepositoryInterface);
  CountryServiceInterface countryServiceInterface = CountryService(countryRepositoryInterface: Get.find());

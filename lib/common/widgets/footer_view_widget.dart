...
class _FooterViewWidgetState extends State<FooterViewWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(mainAxisAlignment: MainAxisAlignment.start, children: [
      ConstrainedBox(
        constraints:
            BoxConstraints(minHeight: (widget.visibility && ResponsiveHelper.isDesktop(context)) ? MediaQuery.of(context).size.height * widget.minHeight : MediaQuery.of(context).size.height * 0.7),
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    FooterButton(title: 'categories'.tr, route: RouteHelper.getCategoryRoute('category')),
                                    const SizedBox(height: Dimensions.paddingSizeSmall),
                                  ],
                                ),
                                Column(
                                  ...
                                  children: [
                                    ...
                                    TextHoverWidget(builder: (hovered) {
                                      return InkWell(
                                        ...
                                        child: Text(Get.find<AuthController>().isLoggedIn() ? 'profile'.tr : 'login'.tr,
                                            style: hovered
                                ...
                                (_config.appUrlAndroid != null || _config.appUrlIos != null)
                                    ? Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
